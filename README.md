...
This is a fork of Mail-in-a-box to 
1. Remove some innecessary "stuff" for those of us with a different use-case.  Postgrey, is a good example, with many complaints from users about delayed email.
...
Start with a completely fresh (really, I mean it) Ubuntu 18.04 LTS 64-bit machine. On the machine...

Clone this repository:

	$ git clone https://github.com/weblogistics/mailinabox-less
	$ cd mailinabox
...
This project was forked from Mail-in-a-Box so, same acknowledgements apply!
